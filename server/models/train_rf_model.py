...
from .enums import ModelLable



def train_model() -> tuple[RandomForestClassifier, TfidfVectorizer, float]:
...
def test_model(content: str, model: RandomForestClassifier, vectorizer: TfidfVectorizer) -> ModelLable:
